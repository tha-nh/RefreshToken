...
public class SampleDataController {
    ...
    private static final String[] CONTENT_SAMPLES = {
            "This item contains detailedssss operational information including workflow steps, revision logs, related attachments, and internal notes. It is generated as part of the system dataset to illustrate how long text fields behave in real application environments.",
